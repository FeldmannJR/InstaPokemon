...
public class EscolheLendarioShiny extends CustomItem {

	public EscolheLendarioShiny() {
		super("Escolhe Pokemon Lendário Shiny", ItemStackBuilder.of(ItemTypes.PAPER).build(), "Ao usar você pode escolher", "um pokemon lendário shiny!");
	...
	public void interact(Player player, InteractType type, ClickInteract click) {
		...
		new EscolhePokeUsaItem(EnumCustomItems.EscolheLendarioShiny,"Escolhe Lendário Shiny") {
