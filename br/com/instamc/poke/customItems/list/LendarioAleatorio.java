...
public class LendarioAleatorio extends CustomItem {

	public LendarioAleatorio() {
	...
	public void interact(Player player, InteractType type, ClickInteract click) {
		...
		InstaPokemon.broadcast("§a" + player.getName() + " §eusou o item Lendário Aleatório e ganhou §a" + lend.name + "§e!");
