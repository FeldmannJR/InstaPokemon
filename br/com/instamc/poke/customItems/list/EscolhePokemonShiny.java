...
public class EscolhePokemonShiny extends CustomItem {

	public EscolhePokemonShiny() {
		super("Escolhe Pokemon Shiny", ItemStackBuilder.of(ItemTypes.PAPER).build(), "Ao usar você pode escolher", "um pokemon shiny!");
	...
	public void interact(Player player, InteractType type, ClickInteract click) {
		...
		new EscolhePokemonMenu(null, 1, true).open(player);
		;
